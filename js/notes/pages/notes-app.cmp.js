...
export default {
    ...
    <note-list v-if="notes" @openColorpick="colorPick" @noteToPin="pinNote" @colorNote="changeNoteColor" @editNote="noteToEdit" @removeNote="noteToRemove" @updateTodo="todoToUpdate" :notes='notes'/>
    </section>
    `,
    data() {
        return {
    ...
    methods: {
        colorPick(noteId) {
            noteService.openColorpick(noteId)
        },
        pinNote(noteId) {
